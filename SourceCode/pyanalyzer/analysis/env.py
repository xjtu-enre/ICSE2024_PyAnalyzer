...
from pyanalyzer.cfg.module_tree import SummaryBuilder
from pyanalyzer.ent.entity import Entity, Location

if TYPE_CHECKING:
    from pyanalyzer.ent.entity import AbstractValue, Class
