...
from pyanalyzer.analysis.analyze_method import FunctionKind
from pyanalyzer.ent.EntKind import EntKind
from pyanalyzer.ent.entity import Entity, Class, Function
