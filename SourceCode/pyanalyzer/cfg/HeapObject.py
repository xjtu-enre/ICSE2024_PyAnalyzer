...
from pyanalyzer.ent.entity import Class, Function, Module

if typing.TYPE_CHECKING:
    from pyanalyzer.cfg.module_tree import FunctionSummary, ClassSummary, ModuleSummary, Invoke, IndexableInfo
