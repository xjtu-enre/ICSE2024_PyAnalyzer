...
from pyanalyzer.cfg.HeapObject import HeapObject, ClassObject, FunctionObject, ModuleObject, NameSpace
from pyanalyzer.ent.entity import Class, Entity, Parameter, Module, UnknownVar, \
    ClassAttribute, Package, Alias, ModuleAlias, PackageAlias
from pyanalyzer.ent.entity import Function, Variable

if typing.TYPE_CHECKING:
    from pyanalyzer.analysis.analyze_expr import ExpressionContext
...
class FunctionSummary(ModuleSummary):
    ...
    def get_object(self) -> FunctionObject:
        if self._correspond_obj:
            ...
            from pyanalyzer.cfg.HeapObject import IndexableObject
...
class SummaryBuilder(object):
    ...
    def load_field(self, field_accesses: StoreAbles, field: str, context: "ExpressionContext",
        ...
        from pyanalyzer.analysis.analyze_expr import SetContext
        ret: List[StoreAble] = []
